...
public class GraphEdgeTest {
	...
	public void testGetOtherNode() throws Exception {
		...
		DiagonalEdge edge = new DiagonalEdge(first, second);
	...
	public void testGetEdgeType() throws Exception {
		DiagonalEdge edge = new DiagonalEdge(new GraphNode("H2"), new GraphNode("F5"));
		Assert.assertEquals(GraphEdge.EdgeType.diagonal, edge.getEdgeType());

		StraightEdge edqe1 = new StraightEdge(new GraphNode("H2"), new GraphNode("F5"));
