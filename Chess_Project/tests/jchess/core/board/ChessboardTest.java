...
public class ChessboardTest {
	...
	@Test
	public void testSetPieces() throws Exception {
		...
		Assert.assertTrue((board.getFields()[0][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[1][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[2][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[3][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[4][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[5][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[6][0].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[7][0].getPiece().getPlayer().getColor() == Player.colors.black));
		...
		Assert.assertTrue((board.getFields()[3][0].getPiece().getSymbol() == King.SYMBOL));
		Assert.assertTrue((board.getFields()[4][0].getPiece().getSymbol() == Queen.SYMBOL));
		...
		Assert.assertTrue((board.getFields()[0][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[1][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[2][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[3][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[4][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[5][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[6][1].getPiece().getPlayer().getColor() == Player.colors.black));
		Assert.assertTrue((board.getFields()[7][1].getPiece().getPlayer().getColor() == Player.colors.black));
		...
		Assert.assertTrue((board.getFields()[0][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[1][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[2][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[3][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[4][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[5][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[6][6].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[7][6].getPiece().getPlayer().getColor() == Player.colors.white));
		...
		Assert.assertTrue((board.getFields()[0][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[1][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[2][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[3][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[4][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[5][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[6][7].getPiece().getPlayer().getColor() == Player.colors.white));
		Assert.assertTrue((board.getFields()[7][7].getPiece().getPlayer().getColor() == Player.colors.white));
		...
		Assert.assertTrue((board.getFields()[3][7].getPiece().getSymbol() == King.SYMBOL));
		Assert.assertTrue((board.getFields()[4][7].getPiece().getSymbol() == Queen.SYMBOL));
