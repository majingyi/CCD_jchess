...
public class PawnPromotionWindow extends JDialog implements ActionListener {
	...
	public PawnPromotionWindow(Frame parent, Player.PlayerColor color) throws FileNotFoundException {
		super(parent);
	 ...
	 */
	public void setColor(Player.PlayerColor color) throws FileNotFoundException {
