...
public class Table {// Table: {two player, one chessboard and x observers}
	...
	public void generateSettings() // generate settings for both players and
																	// observers
	{
	...
	public void sendSettingsToAll() throws IOException // send generated settings
																											// to all clients on this
																											// table
	{
	...
	public void sendMoveToOther(SClient sender, int beginX, int beginY, int endX, int endY) throws IOException {
		...
		if (sender == clientPlayer1 || sender == clientPlayer2) // only player1 and
																														// player2 can move
		{
	...
	public void addPlayer(SClient client) {// join player to game
	...
	public void addObserver(SClient client) {// join observer to game
