...
public class Client implements Runnable {
	...
	public static boolean	isPrintEnable		= true;	// print all messages (print
																									// function)
	Socket								s;
	...
	/*
	 * Method responsible for joining to the server on witch the game was created
	 */
	public boolean join(int tableID, boolean asPlayer, String nick, String password) throws Error // join
	// to
	// server
	{
		...
		while (isOK) {
			try {
				...
				} else if (in.equals("#settings")) // getting settings from server
				{
					...
					int result = JOptionPane.showConfirmDialog(null, Settings.lang("your_oponent_plase_to_undo_move_do_you_agree"), Settings.lang("confirm_undo_move"),
	 ...
	 */
	public void sendMove(int beginX, int beginY, int endX, int endY) // sending
																																		// new move
																																		// to server
	{
	...
	/*
	 * Method responsible for sending to the server informations about moves of a
	 * player
	 */
