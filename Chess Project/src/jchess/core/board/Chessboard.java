...
public class Chessboard {
	...
	private void setFigures4NewGame(int i, Player player) throws Exception {
		...
		if (player.getColor() == Player.colors.white) {
			this.getFields()[3][i].setPiece(kingWhite = new King(this, player));
		} else {
			this.getFields()[3][i].setPiece(kingBlack = new King(this, player));
		}
		this.getFields()[3][i].setPiece(new Queen(this, player));
		if (player.getColor() == Player.colors.white) {
			this.getFields()[4][i].setPiece(kingWhite = new King(this, player));
		} else {
			this.getFields()[4][i].setPiece(kingBlack = new King(this, player));
		}
	}
