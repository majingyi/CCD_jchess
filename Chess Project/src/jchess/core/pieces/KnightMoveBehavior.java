...
public class KnightMoveBehavior extends MoveBehavior {
	...
	public ArrayList<Square> allMoves() {
		...
		if ((Chessboard.isout(newX, newY) == false) && checkPiece(newX, newY)) {
			...
			{
				if (this.chessboard.getKingForColor(Player.colors.white).willBeSafeWhenMoveOtherPiece(this.square, chessboard.squares[newX][newY])) {
					list.add(chessboard.squares[newX][newY]);
				}
			} else // or black
			{
				if (this.chessboard.getKingForColor(Player.colors.black).willBeSafeWhenMoveOtherPiece(this.square, chessboard.squares[newX][newY])) {
					list.add(chessboard.squares[newX][newY]);
				}
			}
		}
